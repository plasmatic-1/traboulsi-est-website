  ...
  return (
    <div className="card group overflow-hidden">
      <div className="relative h-56 w-full overflow-hidden bg-surface">
        ...
        />
        <div className="absolute inset-0 flex flex-col items-start justify-end gap-2 bg-gradient-to-t from-primary/90 via-primary/10 to-transparent p-4 opacity-0 transition-opacity duration-300 group-hover:opacity-100">
          ...
          <span className="mt-1 inline-flex items-center gap-1 rounded-md bg-white px-3 py-1.5 text-xs font-semibold text-primary">
